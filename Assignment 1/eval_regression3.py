...
test_y = irisDataSet.data[:, :1]  # Load or define the true test output values
...
# Loading the model parameters
model_filepath1 = 'model3_without_reg.pkl'
with open(model_filepath1, 'rb') as f:
    model_params1 = pickle.load(f)

# Creating an instance of the LinearRegression class
model2 = LinearRegression()
model2.load('model3_without_reg.pkl')
